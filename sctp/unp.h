...
sctp_assoc_t
sctp_address_to_associd(int sock_fd, struct sockaddr *sa, socklen_t, int associd);
...
int Sctp_recvmsg(int s, void *msg, size_t len,
				 ...
				 int *msg_flags);
				 int 
sctp_get_no_strms(int sock_fd,struct sockaddr *to, socklen_t tolen,int associd);
int
